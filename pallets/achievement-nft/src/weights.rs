//! WeightInfo trait and conservative placeholder weights for pallet_achievement_nft.
//!
...
//!   --pallet=pallet_achievement_nft \
//!   --extrinsic="*" --steps=50 --repeat=20 \
//!   --output=pallets/achievement-nft/src/weights.rs
//! ```
...
/// Weight functions needed for pallet_achievement_nft.
pub trait WeightInfo {
    /// Weight of [`award_achievement`] extrinsic.
    fn award_achievement() -> Weight;
    /// Weight of [`issue_reward_nft`] extrinsic.
    fn issue_reward_nft() -> Weight;
    /// Weight of [`redeem_reward_nft`] extrinsic.
    fn redeem_reward_nft() -> Weight;
}

/// Placeholder weights for pallet_achievement_nft.
///
