//! WeightInfo trait and conservative placeholder weights for pallet_chronicles.
//!
...
//!   --pallet=pallet_chronicles \
//!   --extrinsic="*" --steps=50 --repeat=20 \
//!   --output=pallets/chronicles/src/weights.rs
//! ```
...
/// Weight functions needed for pallet_chronicles.
pub trait WeightInfo {
    /// Weight of [`publish_document`] extrinsic.
    fn publish_document() -> Weight;
    /// Weight of [`donate_to_author`] extrinsic.
    fn donate_to_author() -> Weight;
}

/// Placeholder weights for pallet_chronicles.
///
